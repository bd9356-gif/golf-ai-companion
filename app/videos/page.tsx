            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {visibleVideos.map((video) => {
                  ...
                  return (
                    <div key={video.id} className="border border-gray-200 rounded-xl overflow-hidden hover:border-green-200 transition-colors">
                      {isPlaying && ytId && (
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center gap-3 mt-3">
                          ...
                          >
                            {isSaved ? '🔖 Saved to MyBag' : '🔖 Add to MyBag'}
                          </button>
                        </div>
                          ...
                          <div className="mt-3 border-t border-gray-100 pt-3">
                            {user ? (
                              summary ? (
                                ...
                                <p className="text-sm text-gray-400">No summary available for this video.</p>
                              )
                            ) : (
