...
const FEATURES = [
  {
    emoji: '📺',
    title: 'Golf TV',
    blurb: 'Every lesson, one tap away.',
    href: '/golf-tv',
  },
  {
    emoji: '🏌️',
    title: 'My Golf Bag',
    blurb: 'Save, sort, and build your game.',
    href: '/bag',
  },
  {
    emoji: '🏠',
    title: 'My Courses',
    blurb: 'Notes, tips, tee times.',
    href: '/home-courses',
  },
  {
    emoji: '📖',
    title: 'Playbook',
    blurb: 'Read smarter. Play better.',
    href: '/guides',
  },
  {
    emoji: '🎓',
    title: 'Club Pro',
    blurb: 'Ask anything. Get clear answers.',
    href: '/club-pro',
  },
]
