      ...
      <main className="flex-1 flex items-start justify-center px-4 pt-6 pb-8">
        <div className="w-full max-w-sm">
          <div className="text-center mb-5">
            ...
            <p className="text-gray-500 mt-1">Sign in to your clubhouse</p>
          </div>
          ...
          <div className="mb-4">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-white border-2 border-green-700 rounded-xl text-base font-semibold text-gray-800 hover:bg-green-50 transition-colors shadow-sm"
            >
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center">
              <span className="bg-green-50 px-3 text-xs text-gray-400 uppercase tracking-wide">or</span>
            </div>
          </div>

          {/* ─── Option 2: Any other email (magic link) ─── */}
          {sent ? (
            <div className="mb-6 px-4 py-4 bg-white border-2 border-green-200 rounded-xl text-sm text-green-800">
            ...
            <form onSubmit={handleMagicLink} className="mb-5">
              ...
              <input
                ...
                style={{ fontSize: '16px' }}
                className="w-full px-4 py-3 bg-white border-2 border-green-100 rounded-xl mb-3 focus:outline-none focus:border-green-600"
              />
              <button
                type="submit"
                disabled={sending || !email.trim()}
                className="w-full px-4 py-3 bg-white border-2 border-green-200 hover:border-green-400 hover:bg-green-50 disabled:opacity-60 text-green-800 font-semibold rounded-xl transition-colors"
              >
