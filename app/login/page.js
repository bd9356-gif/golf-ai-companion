      ...
      <main className="flex-1 flex items-start justify-center px-4 pt-6 pb-8">
        <div className="w-full max-w-sm">
          ...
          {sent ? (
            ...
            <form onSubmit={handleMagicLink} className="mb-5">
              ...
              <input
                ...
                style={{ fontSize: '16px' }}
                className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl mb-3 focus:outline-none focus:border-green-600"
              />
              <button
                type="submit"
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors mb-6"
          >
