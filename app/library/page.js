        ...
        {isPlaying && ytId ? (
          ...
          <div className="flex items-center gap-3 p-3">
            ...
            <div className="flex flex-col gap-5 items-end shrink-0">
              <button onClick={() => removeVideo(saved.video_id)} className="text-sm text-red-400 hover:text-red-600 font-semibold py-1 px-2 flex items-center gap-1"><img src="/bag-icon.svg" width="14" height="14" style={{display:"inline",verticalAlign:"middle"}} alt="" /> Remove</button>
              <CartButton itemId={saved.video_id} itemType="video" itemTitle={video.title} />
            </div>
          </div>
        )}
    ...
    return (
      <div key={saved.article_id} id={`item-${saved.article_id}`} className="border border-gray-200 rounded-xl overflow-hidden hover:border-green-200 transition-colors">
        <div className="flex items-start gap-3 p-4">
          ...
          <div className="flex flex-col gap-5 items-end shrink-0">
            <button onClick={() => removeArticle(saved.article_id)} className="text-sm text-red-400 hover:text-red-600 font-semibold py-1 px-2 flex items-center gap-1"><img src="/bag-icon.svg" width="14" height="14" style={{display:"inline",verticalAlign:"middle"}} alt="" /> Remove</button>
    ...
    return (
      <div key={item.id} id={`item-${item.id}`} className="border border-gray-200 rounded-xl overflow-hidden hover:border-green-200 transition-colors">
        <div className="flex items-start gap-3 p-4">
          ...
          <div className="flex flex-col gap-5 items-end shrink-0">
            <button onClick={() => removeAnswer(item.id)} className="text-sm text-red-400 hover:text-red-600 font-semibold py-1 px-2 flex items-center gap-1"><img src="/bag-icon.svg" width="14" height="14" style={{display:"inline",verticalAlign:"middle"}} alt="" /> Remove</button>
